package br.com.mutante.impl;

import java.util.regex.Pattern;

import br.com.mutante.excpetion.InputValidationException;



public class MontaTableMutante {
	
	private static char[][] dnaSecuence;
...
private static boolean readHorizontalOrVertical(ReadDirections direction, char startChar, int index) {
	...
	private static char[][] populaDna(String[] dna) throws InputValidationException {
...
private static boolean readDiagonals(DiagonalReadDirections leftOrRight, DiagonalReadType aboveOrBelow, int baseN, int baseM) {
